...
mia.hofmann@email.de · 0176 123 456 78`
  ...
  /* ============================================================
   * 17 · NEUSTART — Ein Brief aus Deutschland · B1 · readingOnly
   * ============================================================ */
  neustart: {
    slug: 'neustart',
    emoji: '📬',
  ...
  nachrichten: {
    ...
    reading: {
      paragraphs: [
        'Im Jahr 2024 haben viele Firmen in Deutschland eine wichtige <mark title="рішення прийняти">Entscheidung getroffen</mark>: Sie testen die Vier-Tage-Woche. Das bedeutet: Die <mark title="співробітники">Mitarbeiter</mark> arbeiten nur vier Tage pro Woche — nicht fünf, bekommen aber das gleiche <mark title="зарплата">Gehalt</mark> wie vorher. Das klingt verlockend — doch für viele Firmen ist es eine echte <mark title="виклик, складність">Herausforderung</mark>.',
        'In anderen Ländern — zum Beispiel in Großbritannien und Island — hat man das Modell schon <mark title="протестовано">getestet</mark>. <mark title="порівняно з">Im Vergleich zu</mark> vorher waren die Mitarbeiter weniger <mark title="в стресі">gestresst</mark>, hatten weniger <mark title="дні відсутності">Fehltage</mark> und die <mark title="продуктивність">Produktivität</mark> hat sich sogar <mark title="покращилась">verbessert</mark>. Jetzt will Deutschland das auch probieren.',
        'Eine Firma in Hamburg — ein Software-Unternehmen mit 80 Mitarbeitern — <mark title="набирається досвіду">sammelt schon Erfahrungen</mark> mit der neuen <mark title="робочий час">Arbeitszeit</mark>. Die Chefin, Frau Koch, hat die <mark title="взяла на себе відповідальність">Verantwortung übernommen</mark> und das Modell als erste in der Region eingeführt. Sie sagt: «Unsere Mitarbeiter schlafen besser, haben mehr <mark title="енергія">Energie</mark> und machen weniger Fehler.» Einige nutzen den freien Tag für Sport, andere lernen eine neue Sprache.',
        'Aber nicht alle sind <mark title="захоплені">begeistert</mark>. Manche <mark title="роботодавці">Arbeitgeber</mark> sehen mehr <mark title="недоліки">Nachteile</mark> als <mark title="переваги">Vorteile</mark>: «In vier Tagen kann man nicht so viel <mark title="встигнути зробити">leisten</mark> wie in fünf.» In <mark title="галузях">Branchen</mark> wie der Gastronomie oder in Krankenhäusern müssen die Teams erst eine gute <mark title="знайти рішення">Lösung finden</mark>, um Konflikte bei den <mark title="зміни (графік)">Schichten</mark> zu <mark title="уникнути">vermeiden</mark>.',
        'Die <mark title="федеральний уряд">Bundesregierung</mark> beobachtet die Ergebnisse genau. Eine wichtige <mark title="умова, передумова">Voraussetzung</mark> für den Erfolg ist, dass sich alle Beteiligten wirklich <mark title="намагаються, докладають зусиль">bemühen</mark> — Arbeitgeber genauso wie <mark title="працівники">Arbeitnehmer</mark>. Bis Ende 2025 sollen mehr als 50 Firmen an dem Projekt <mark title="брати участь">teilnehmen</mark>. Ob die Vier-Tage-Woche in ganz Deutschland kommt, ist noch offen.',
        'Markus, 34, arbeitet als <mark title="програміст">Programmierer</mark> in Hamburg. Er <mark title="цікавиться">interessiert sich</mark> schon lange für neue Arbeitsmodelle und hat sofort mitgemacht. Er sagt: «Früher war ich freitags <mark title="неуважний, незосереджений">unkonzentriert</mark> und erschöpft. Jetzt verbringe ich den Freitag mit meiner Familie. Am Montag komme ich <mark title="відпочилий">ausgeruht</mark> ins Büro.» Seine <mark title="колеги">Kollegen</mark> fühlen sich ebenfalls weniger <mark title="вигорілий">ausgebrannt</mark>.',
        'Eine <mark title="дослідження">Studie</mark> der Universität Münster zeigt: 72 Prozent der Deutschen würden gerne weniger arbeiten, wenn das Gehalt gleich bleibt. Besonders junge Menschen zwischen 25 und 35 wünschen sich mehr Zeit für <mark title="хобі">Hobbys</mark> und Familie. Für viele ist die <mark title="баланс роботи та особистого">Work-Life-Balance</mark> wichtiger als ein höheres Gehalt.',
        'In Japan <mark title="рекомендувала">empfahl</mark> die Regierung schon 2021, die Vier-Tage-Woche einzuführen. Microsoft Japan testete das Modell — die <mark title="продуктивність">Produktivität</mark> stieg um 40 Prozent. In Belgien haben <mark title="працівники">Arbeitnehmer</mark> seit 2022 das Recht, vier Tage zu arbeiten, ohne weniger zu <mark title="заробляти">verdienen</mark>. Deutschland schaut genau, was in diesen Ländern passiert.',
        'Die große Frage bleibt offen. <mark title="експерти">Experten</mark> <mark title="відстоюють різні думки">vertreten unterschiedliche Meinungen</mark>: Manche glauben, weniger Zeit bedeutet mehr Fokus. Andere zweifeln. Frau Koch sagt: «<mark title="на мою думку">Aus meiner Sicht</mark> ist die Vier-Tage-Woche die Zukunft — aber man braucht Mut und Geduld, sie <mark title="впровадити">einzuführen</mark>.» Deutschland will das <mark title="з\'ясувати">herausfinden</mark> — und die Ergebnisse könnten das Arbeitsleben von Millionen <mark title="змінити">verändern</mark>.'
      ],
      uaSummary: '🇺🇦 Новина про чотириденний робочий тиждень у Німеччині. Компанії приймають рішення тестувати нову модель — та сама зарплата, на день менше. У Британії та Ісландії продуктивність покращилась. Компанія в Гамбурзі вже взяла на себе відповідальність і почала. Програміст Маркус у п\'ятницю — з родиною, у понеділок — більш зосереджений. 72% німців хочуть менше працювати. Японія і Бельгія вже ввели 4-денний тиждень. Думки експертів розходяться. Директорка Кох: «На мою думку — це майбутнє».'
    },
    leseverstehen: {
      teil1: {
